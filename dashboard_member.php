...
<body>
        ...
        <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.5);">
            ...
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col text-center">
                    <h5 style="font-size: 40px; font-weight:600;color:white;">SELAMAT DATANG DI E-LIBLARI KELOMPOK KAMI
                    </h5>
                    <p class="desk-home mt-3" style="font-size: 20; font-weight:600;color:white;">Silahkan pilih buku
                        yang
                        anda ingin
                        baca dengan berbagai buku yang kami sediakan di e-liblari kami
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="row my-5 justify-content-center">
                <div class="col-4">
                    <div class="card-layanan m-auto text-center"
                        ...
                        <div class="card-body">
                            <a style="text-decoration: none; color:black;" href="">Keanggotaan online perpustakaan</a>
                        </div>
                    </div>
                </div>
                <div class="col-4">
                    <div class="card-layanan m-auto text-center"
                        style="width: 18rem;transition: all 0.2s; border:1px solid;border-style: dashed;">
                        <a href="menu_buku.php">
                            <h1 class="font-bold text-center text-primary" style="font-size:60px;">
                                <i class="fa-solid fa-book-atlas"></i>
                            </h1>
                        </a>
                        <div class="card-body">
                            <a style="text-decoration: none; color:black;" href="menu_buku.php">Koleksi
                                Buku Perpustakaan online</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="profile" class="profile section-padding">
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h2><span class="text-primary">E-Liblari</span> E-BOOK</h2>
                </div>
            </div>
        </div>
        <div class="container">
                ...
                <div class="col-sm-3 mb-3 mb-sm-0">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="menu_buku.php?kategori=pemrograman" class="btn btn-primary"
                ...
                <div class="col-sm-3 mb-3 mb-sm-0">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="menu_buku.php?kategori=novel" class="btn btn-primary" style="width:auto;">Lihat
                                E-Book</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3 mb-3 mb-sm-0">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="menu_buku.php?kategori=komik" class="btn btn-primary" style="width:auto;">Lihat
                                E-Book</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3 mb-3 mb-sm-0">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="menu_buku.php?kategori=filsafat" class="btn btn-primary" style="width:auto;">Lihat
                                E-Book</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3 mb-3 mb-sm-0 mt-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="menu_buku.php?kategori=hukum" class="btn btn-primary" style="width:auto;">Lihat
                                E-Book</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3 mb-3 mb-sm-0 mt-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="menu_buku.php?kategori=biografi" class="btn btn-primary" style="width:auto;">Lihat
                                E-Book</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3 mb-3 mb-sm-0 mt-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="menu_buku.php?kategori=dongeng" class="btn btn-primary" style="width:auto;">Lihat
                                E-Book</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3 mb-3 mb-sm-0 mt-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="menu_buku.php?kategori=informatika" class="btn btn-primary"
                                style="width:auto;">Lihat E-Book</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container lihat-semua">
            <div class="text-center align-center mt-5 py-2 mb-1">
                <a href="menu_buku.php?kategori=semua" class="btn btn-primary" style="width:auto;">Lihat Semua</a>
            </div>
        </div>
